...
tJoin_1 AS (SELECT tFileInputDelimited_1.study_id, tFileInputDelimited_1.program_id, tFileInputDelimited_1.study_name FROM tFileInputDelimited_1 INNER JOIN tFileInputDelimited_2 ON tFileInputDelimited_1.study_id = tFileInputDelimited_2.study_id),
